...
# add OTU to end of lineage to go beyond species resolution
...
# Narrow down this abundance matrix to just the indicator taxa (don't need to be significant)
...
############
# Plot just the global site indicators from 
...
pdf("FS6_indic_heatmap_ESVs.pdf", width = 8, height=10)
print(h)
dev.off()
